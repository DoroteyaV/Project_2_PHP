...
function get_buttons($flag, $id)
{
    ...
    $delete = '<button type="button" class="btn btn-danger btn-sm" title="Delete Task" data-toggle="modal" data-target="#myModal-'.$id.'"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</button>';
